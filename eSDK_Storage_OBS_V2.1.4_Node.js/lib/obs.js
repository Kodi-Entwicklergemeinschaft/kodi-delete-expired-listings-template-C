...
ObsClient.prototype.initLog = function(param){
	param = param || {};
	this.log.initLog(param.file_full_path, param.max_log_size, param.backups, param.level, param.log_to_console);
	var msg = ['[OBS SDK Version=' + this.util._obsSdkVersion];
	if(this.util.server){
...
ObsClient.prototype.listBuckets = function(callback){
	this.exec('ListBuckets', {}, callback);
};

ObsClient.prototype.headBucket = function(param, callback){
	this.exec('HeadBucket', param, callback);
};

ObsClient.prototype.getBucketMetadata = function(param, callback){
	this.headBucket(param, callback);
};

ObsClient.prototype.deleteBucket = function(param, callback){
	this.exec('DeleteBucket', param, callback);
};

ObsClient.prototype.setBucketQuota = function(param, callback){
	this.exec('SetBucketQuota', param, callback);
};

ObsClient.prototype.getBucketQuota = function(param, callback){
	this.exec('GetBucketQuota', param, callback);
};

ObsClient.prototype.getBucketStorageInfo = function(param, callback){
	this.exec('GetBucketStorageInfo', param, callback);
};

ObsClient.prototype.setBucketPolicy = function(param, callback){
	this.exec('SetBucketPolicy', param, callback);
};

ObsClient.prototype.getBucketPolicy = function(param, callback){
	this.exec('GetBucketPolicy', param, callback);
};

ObsClient.prototype.deleteBucketPolicy = function(param, callback){
	this.exec('DeleteBucketPolicy', param, callback);
};

ObsClient.prototype.setBucketVersioningConfiguration = function(param, callback){
	this.exec('SetBucketVersioningConfiguration', param, callback);
};

ObsClient.prototype.getBucketVersioningConfiguration =  function(param, callback){
	this.exec('GetBucketVersioningConfiguration', param, callback);
};

ObsClient.prototype.getBucketLocation = function(param, callback){
	this.exec('GetBucketLocation', param, callback);
};

ObsClient.prototype.listVersions = function(param, callback){
	this.exec('ListVersions', param, callback);
};

ObsClient.prototype.listObjects = function(param, callback){
	this.exec('ListObjects', param, callback);
};

ObsClient.prototype.setBucketLifecycleConfiguration = function(param, callback){
	this.exec('SetBucketLifecycleConfiguration', param, callback);
};

ObsClient.prototype.getBucketLifecycleConfiguration = function(param, callback){
	this.exec('GetBucketLifecycleConfiguration', param, callback);
};

ObsClient.prototype.deleteBucketLifecycleConfiguration = function(param, callback){
	this.exec('DeleteBucketLifecycleConfiguration', param, callback);
};

ObsClient.prototype.setBucketAcl = function(param, callback){
	this.exec('SetBucketAcl', param, callback);
};

ObsClient.prototype.getBucketAcl = function(param, callback){
	this.exec('GetBucketAcl', param, callback);
};

ObsClient.prototype.setBucketLoggingConfiguration = function(param, callback){
	param['LoggingEnabled'] = param['LoggingEnabled'] || {};
	this.exec('SetBucketLoggingConfiguration', param, callback);
};

ObsClient.prototype.getBucketLoggingConfiguration = function(param, callback){
	this.exec('GetBucketLoggingConfiguration', param, callback);
};

ObsClient.prototype.setBucketWebsiteConfiguration = function(param, callback){
	this.exec('SetBucketWebsiteConfiguration', param, callback);
};

ObsClient.prototype.getBucketWebsiteConfiguration = function(param, callback){
	this.exec('GetBucketWebsiteConfiguration',param, callback);
};

ObsClient.prototype.deleteBucketWebsiteConfiguration = function(param, callback){
	this.exec('DeleteBucketWebsiteConfiguration', param, callback);
};

ObsClient.prototype.setBucketNotification = function(param,callback){
	param['TopicConfiguration'] = param['TopicConfiguration'] || {};
	this.exec('SetBucketNotification', param, callback);
};

ObsClient.prototype.getBucketNotification = function(param, callback){
	this.exec('GetBucketNotification', param, callback);
};

ObsClient.prototype.setBucketTagging = function(param,callback){
	this.exec('SetBucketTagging', param, callback);
};

ObsClient.prototype.deleteBucketTagging = function(param, callback){
	this.exec('DeleteBucketTagging', param, callback);
};

ObsClient.prototype.getBucketTagging = function(param, callback){
	this.exec('GetBucketTagging', param, callback);
};
...
ObsClient.prototype.getObject = function(param, callback){
	this.exec('GetObject', param, callback);
};
...
ObsClient.prototype.getObjectMetadata = function(param, callback){
	this.exec('GetObjectMetadata', param, callback);
};

ObsClient.prototype.setObjectAcl = function(param, callback){
	this.exec('SetObjectAcl', param, callback);
};

ObsClient.prototype.getObjectAcl = function(param, callback){
	this.exec('GetObjectAcl', param, callback);
};

ObsClient.prototype.deleteObject = function(param, callback){
	this.exec('DeleteObject', param, callback);
};

ObsClient.prototype.deleteObjects = function(param, callback){
	this.exec('DeleteObjects', param, callback);
};
...
ObsClient.prototype.listMultipartUploads = function(param, callback){
	this.exec('ListMultipartUploads', param, callback);
};
...
ObsClient.prototype.listParts = function(param, callback){
	this.exec('ListParts', param, callback);
};
...
ObsClient.prototype.abortMultipartUpload = function(param, callback){
	this.exec('AbortMultipartUpload', param, callback);
};

ObsClient.prototype.completeMultipartUpload = function(param,callback){
	this.exec('CompleteMultipartUpload', param, callback);
};

ObsClient.prototype.setBucketCors = function(param, callback){
	this.exec('SetBucketCors', param, callback);
};

ObsClient.prototype.getBucketCors = function(param, callback){
	this.exec('GetBucketCors', param, callback);
};

ObsClient.prototype.deleteBucketCors = function(param, callback){
	this.exec('DeleteBucketCors', param, callback);
};

ObsClient.prototype.optionsBucket = function(param, callback){
	this.exec('OptionsBucket', param, callback);
};

ObsClient.prototype.optionsObject = function(param, callback){
	this.exec('OptionsObject', param, callback);
};

ObsClient.prototype.setBucketStoragePolicy = function(param, callback){
	this.exec('SetBucketStoragePolicy', param, callback);
};

ObsClient.prototype.getBucketStoragePolicy = function(param, callback){
	this.exec('GetBucketStoragePolicy', param, callback);
};
...
ObsClient.prototype.uploadFile = function(param, callback){
	...
	var calculateUploadCheckpointMD5 = function(uploadCheckpoint){
		...
		return obsClient.util.strMD5(data.join(''));
	};
